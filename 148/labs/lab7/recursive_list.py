...
class RecursiveList:
    ...
    def __setitem__(self, index: int, item: Any) -> None:
        ...
        if index == 0:
            ...
            #         raise IndexError
            #     else:
            #         self._rest._first = item
            # else:
            self._rest.__setitem__(index - 1, item)

    def _insert_first(self, item: object) -> None:
        ...
        >>> print(lst)
        5
        >>> lst._insert_first(10)
        >>> print(lst)
        10 -> 5
        >>> lst._insert_first(20)
        >>> print(lst)
        20 -> 10 -> 5
        >>> lst._insert_first(1)
        >>> print(lst)
    ...
    def map(self, f: Callable[[Any], Any]) -> RecursiveList:
        ...
        if self.is_empty():
            ...
            new = RecursiveList([])
            new._first = f(self._first)
            new._rest = self._rest.map(f)
            return new
